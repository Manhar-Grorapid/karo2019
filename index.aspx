<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="newstart.index" %>
    ...
    <form id="form1" runat="server">
                ...
                <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #000000;">
                    <div class="container">
                        <a href="#" class="navbar-brand">
                            <img src="./imagee/microsoft-logo.png" width="130" height="30" /></a>
        ...
        Estimator</a>
                ...
                <div class="container pt-5"
                    style="height: 450px; background-image: url(imagee/banner.png); background-size: cover">
